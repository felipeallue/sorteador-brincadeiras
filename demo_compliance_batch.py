...
def main():
    ...
    brhub_query, brhub_params = brhub_builder.build_query()
    print(brhub_query)
    print()
    print(f"Parameters: {brhub_params}")
    print()
    print("Key Features:")
    print("  ✓ Filters by tipoobjintegr_id = ? (third-party service invoices)")
    print("  ✓ Filters by sitdocto = ? (excludes cancelled invoices)")
    print("  ✓ Selects from nota_fiscal_servico table")
    print("  ✓ Uses parameterized queries to prevent SQL injection")
    print()
    print()
    ...
    suiteapps_query, suiteapps_params = suiteapps_builder.build_query()
    print(suiteapps_query)
    print()
    print(f"Parameters: {suiteapps_params}")
    print()
    print("Key Features:")
    print("  ✓ Filters by tipoobjintegr_id = ? (third-party service invoices)")
    print("  ✓ Filters by sitdocto = ? (excludes cancelled invoices)")
    ...
    print("  AND sitdocto = ? (with parameter '00')")
    print()
    ...
    print()
    print("Security: Parameterized queries prevent SQL injection attacks.")
    print()
